...
alias gsh='git show'
alias gstat='git -c color.status=always status'
alias gstat.s='git -c color.status=always status --short'
alias gst='git stash'
alias gst.a='git stash apply'
alias gst.l='git stash list'
alias gst.m='git stash -m'
alias gst.u='git stash -u'
alias gst.um='git stash -u -m'
alias gst.p='git stash pop'
alias gta='git tag'
